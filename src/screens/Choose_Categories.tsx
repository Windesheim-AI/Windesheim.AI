...
import { FaChevronUp, FaChevronDown, FaRegSquare, FaRegCheckSquare, FaArrowRight } from 'react-icons/fa';
...
const ChooseCategories: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Description>
        Der Maturity Scan Light hilft Ihnen, den Reifegrad Ihrer Organisation einzuschätzen.{'\n'}
        ...
        {categories.map((category, index) => (
          ...
          >
            <CategoryHeader>
              ...
              >
                {selectedCategories.includes(index) ? <FaRegCheckSquare size={20} /> : <FaRegSquare size={20} />}
              </CheckBox>
            ...
            <CategoryContent isExpanded={expandedCategories.includes(index)}>
