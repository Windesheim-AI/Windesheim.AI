...
export const tutorialSteps: TutorialStep[] = [
    ...
    },
    {
        ...
        Subtext:
            'On this screen you can listen  to podcasts and read the articles about Generative AI. They are also divided into different categories: Ethical, Legal, Social, and Technical.', //changed
    ...
    },
    {
        ...
        Subtext:
            'On this screen you can watch the courses about Generative AI. Also you can practice and test yourself with quizzes.', //changed
    ...
    },
    {
        Title: 'Prompts',
        Subtext:
            'On this screen you can find prompts to help you with your creative process. You can find a tutorial about how to use them in the settings page.', //changed
    ...
    },
    {
        ...
        Subtext:
            'On this screen you can browse the Windesheim Tech Radar, which is a collection of the newest trends & innovations in the tech industry. You can also find the latest trends with the biggest tech providers.', //added
